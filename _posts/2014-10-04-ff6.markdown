...
<div class="row" style="margin-top:1em;">
	...
	<div class="col-md-8">
		...
		<p>
			<ol>If I had to make a ranking of ports (excluding the new mobile version)
				<li>Game Boy Advance</li>
				<li>SNES</li>
				<li>PSX</li>
			</ol>
		The load time on the PSX version is <strong>bad</strong> to the point where I'd take the game-breaking bugs of the SNES version over it.
		</p>	
	</div>
	
		<div class="col-md-4">
			<img src="/assets/ff64.png" class="img img-responsive">	
			<small class="text-center">All the typography in FF6 is demonstrably worse than other Final Fantasy games on the same hardware. <br> The typography in FF4 GBA is much better, for example.</small>
		</div>
</div>
