...
<div class='row'>
	...
	Considering that xkcd comic about standards, I'm hopeful the limited scope of GPU functionality allows "this to happen":https://www.khronos.org/vulkan
	
	</div>
	<div class='col-md-6'>
	<img src='http://ih1.redbubble.net/image.6630487.7382/fig,white,mens,ffffff.jpg' class='img img-responsive' />
	Although it the first open-source typsetting system and a historic Computer Science text, "the typography hasn't aged that well.":http://www.redbubble.com/people/novelnetwear/works/4107382-kernighan-and-ritchie?p=t-shirt
	</div>
</div>